...
import api.tests.AssignmentSubTests;
...
public class Post_subassignment {
	...
	AssignmentSubTests post=new AssignmentSubTests();
	...
	@When(": User sends request Body from excel {string} and {int}")
		...
		List<Map<String,String>> testData=
				reader.getData(System.getProperty("user.dir") +
			"/src/test/resources/excelFiles/Datadriventest.xlsx", SheetName);
		...
		{
		post.TestPostUser(desc,postcomment,subpath1,subpath2,subpath3,subpath4,subpath5);
		}
		...
		else
		{
			String aid="";
			String uid="";
			post.Testputgrade(aid,uid,desc,postcomment,subpath1,subpath2,subpath3,subpath4,subpath5);
		}
	...
	public void user_receives_created_status_with_response_body(int code) {
