...
public class NegativeassignSubmit {
		...
		public void payload_by_excel_and(String SheetName,int RowNumber) throws InvalidFormatException, IOException {
			...
			//		(".\\testData\\Datadriventest.xlsx", SheetName);
			
			List<Map<String,String>> testData=reader.getData
					("/src/test/resources/excelFiles/Datadriventest.xlsx", SheetName);
	     	
			String assignid=testData.get(RowNumber).get("assignmentId");
			...
			{
				post.Testputgrade(assignid,userid,desc,postcomment,subpath1,subpath2,subpath3,subpath4,subpath5);
			}
