...
//		response.then().log().all();
		vResponse= AssignmentEndPoints.createAssignment(assignmentPayload);		
		...
		if (vResponse.extract().statusCode()== 201){
			...
			Loggerload.info("AssignmentId :"+ GlobalVar.assignmentId + "*********************** Assignment is Created ****************");
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ GET @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
	...
	public void TestGetAssignmentsByBatchId(int id) {
		Loggerload.info("---For BatchId : " + id + "*********************** Retrieving Assignment *************");
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ UPDATE @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
	...
	public void TestUpdateAssignment(int id, String desc, String name, int batchId,
		...
		assignmentPayload.setPathAttachment4(path4);
		assignmentPayload.setPathAttachment5(path5);
		Loggerload.info("---For AssignmentId : " + id + "*********************** Updating assignment *************");
